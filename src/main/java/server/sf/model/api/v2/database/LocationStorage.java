        ...
        return DatabaseManager.db().executeQuery(
                ...
                rs -> {
                    try {
                        ...
                        server.sf.model.api.v2.SF.sf().error("getHome read failed", e);
                        return null;
                    }
                },
                uuid.toString(), name
        ...
        return DatabaseManager.db().executeQuery(
                ...
                rs -> {
                    ...
                    try {
                        ...
                        server.sf.model.api.v2.SF.sf().error("getHomes read failed", e);
                    }
                    return map;
                },
                uuid.toString()
        ...
        return DatabaseManager.db().executeQuery(
                ...
                rs -> {
                    try {
                        ...
                        server.sf.model.api.v2.SF.sf().error("getWarp read failed", e);
                        return null;
                    }
                },
                name
        ...
        return DatabaseManager.db().executeQuery(
                ...
                rs -> {
                    ...
                    try {
                        ...
                        server.sf.model.api.v2.SF.sf().error("getWarps read failed", e);
                    }
                    return map;
                }
        );
        ...
        return DatabaseManager.db().executeQuery(
                ...
                rs -> {
                    try {
                        ...
                        server.sf.model.api.v2.SF.sf().error("getLastLocation read failed", e);
                        return null;
                    }
                },
                uuid.toString()
